...
bool FFT::Forward(complex *const Data, const unsigned int N)
{
    //   Check input parameters
    if (!Data || N < 1 || N & (N - 1))
        return false;
...
//   Rearrange function
void FFT::Rearrange(const complex *const Input, complex *const Output, const unsigned int N)
{
    //   Data entry position
...
void FFT::Rearrange(complex *const Data, const unsigned int N)
{
    //   Swap position
    unsigned int Target = 0;
    //   Process all positions of input signal
...
//   FFT implementation
void FFT::Perform(complex *const Data, const unsigned int N, const bool Inverse /* false */)
{
...
void FFT::Scale(complex *const Data, const unsigned int N)
{
